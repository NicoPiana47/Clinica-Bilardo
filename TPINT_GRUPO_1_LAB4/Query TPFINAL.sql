/*drop database BD_TPINT_GRUPO_1_LAB4;*/

create schema BD_TPINT_GRUPO_1_LAB4;
use BD_TPINT_GRUPO_1_LAB4;

-- CREACION DE TABLAS

CREATE TABLE Provincias
(
	CodProvincia_PROV int auto_increment NOT NULL,
	Descripcion_PROV VARCHAR(50) NOT NULL,

	CONSTRAINT PK_PROVINCIAS PRIMARY KEY (CodProvincia_PROV)
);

CREATE TABLE Localidades(
	CodProvincia_LOC int NOT NULL,
    CodLocalidad_LOC int auto_increment NOT NULL,
	Descripcion_LOC VARCHAR(50) NOT NULL,

	CONSTRAINT PK_LOCALIDADES PRIMARY KEY (CodLocalidad_LOC, CodProvincia_LOC),
    CONSTRAINT FK_LOCALIDADES_PROVINCIAS FOREIGN KEY (CodProvincia_LOC)
		REFERENCES Provincias(CodProvincia_PROV)
);

CREATE TABLE Especialidades (
    CodEspecialidad_ESP INT AUTO_INCREMENT  NOT NULL,
...
CREATE TABLE EstadosTurno (
    CodEstado_EST INT AUTO_INCREMENT  NOT NULL,
    Descripcion_EST VARCHAR(100) NOT NULL,
    
    CONSTRAINT PK_ESTADOS PRIMARY KEY (CodEstado_EST)
);

CREATE TABLE Pacientes (
	CodPac_PAC INT AUTO_INCREMENT NOT NULL,
    DNI_PAC VARCHAR(10) NOT NULL,
    CodProvincia_PAC INT NOT NULL,
    CodLocalidad_PAC INT NOT NULL,
    Nombre_PAC VARCHAR(50) NULL,
    Apellido_PAC VARCHAR(50) NULL,
    Correo_PAC VARCHAR(100) NOT NULL,
    Sexo_PAC VARCHAR(10) NULL,
    Nacionalidad_PAC VARCHAR(50) NULL,
    FechaNacimiento_PAC DATE NULL,
    Direccion_PAC VARCHAR(100) NULL,
    Telefono_PAC VARCHAR(15) NULL,
    Estado_PAC BOOLEAN NOT NULL DEFAULT 1,
    
    CONSTRAINT PK_PACIENTES PRIMARY KEY (CodPac_PAC),
    CONSTRAINT FK_LOCALIDADES_PACIENTES FOREIGN KEY (CodLocalidad_PAC, CodProvincia_PAC)
		REFERENCES Localidades(CodLocalidad_LOC, CodProvincia_LOC),
	
    CONSTRAINT UK_PACIENTES_DNI UNIQUE KEY (DNI_PAC),
    CONSTRAINT UK_PACIENTES_CORREO UNIQUE KEY (Correo_PAC)
);

CREATE TABLE Medicos (
    CodMed_MED INT AUTO_INCREMENT NOT NULL,
    DNI_MED VARCHAR(10) NOT NULL,
    CodEspecialidad_MED INT NOT NULL,
    CodLocalidad_MED INT NOT NULL,
    CodProvincia_MED INT NOT NULL,
    Correo_MED VARCHAR(100) NOT NULL,
    Username_MED VARCHAR(50) UNIQUE NOT NULL,
    Contraseña_MED VARCHAR(50) NOT NULL,
    Nombre_MED VARCHAR(50) NULL,
    Apellido_MED VARCHAR(50) NULL,
    Sexo_MED VARCHAR(10) NULL,
    Nacionalidad_MED VARCHAR(50) NULL,
    ...
    CONSTRAINT FK_LOCALIDADES_MEDICOS FOREIGN KEY (CodLocalidad_MED, CodProvincia_MED)
		REFERENCES Localidades(CodLocalidad_LOC, CodProvincia_LOC),
	CONSTRAINT FK_ESPECIALIDADES_MEDICOS FOREIGN KEY (CodEspecialidad_MED)
		REFERENCES Especialidades(CodEspecialidad_ESP),
        
	CONSTRAINT UK_MEDICOS_DNI UNIQUE KEY (DNI_MED),
...
INSERT INTO Localidades (CodLocalidad_LOC, CodProvincia_LOC, Descripcion_LOC) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
INSERT INTO Especialidades(Descripcion_ESP)
VALUES 
('Medicina General'),
('Pediatría'),
('Ginecología'),
...
INSERT INTO EstadosTurno (Descripcion_EST)
VALUES 
('Libre'),
('Ocupado'),
('Ausente'),
...
INSERT INTO Pacientes(DNI_PAC, CodProvincia_PAC,CodLocalidad_PAC, Nombre_PAC, Apellido_PAC, Correo_PAC, Sexo_PAC, Nacionalidad_PAC, FechaNacimiento_PAC, Direccion_PAC, Telefono_PAC, Estado_PAC)
VALUES
('43818699','1','122','Lautaro','Lomazzo','llomazo@gmail.com','Masculino','Argentina', "2002-03-20", 'Juan b. Justo 2232', 1122334455, 1),
('43259884','1','32','Alan','Lewandowski','alewandowski@gmail.com','Masculino','Argentina', "2001-03-17", 'Francisco Bilbao 10361', 1127601228, 1),
