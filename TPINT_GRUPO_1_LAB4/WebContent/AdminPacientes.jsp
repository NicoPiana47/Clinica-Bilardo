			...
			<table class="table table-hover text-center" id="table_id_usuarios" style="font-size: 11px;">
		        ...
		        <tbody>
				    ...
				    <tr onclick="openModal('modalPaciente', true)">
				            <td scope="row">
				                <button style="position:relative;" type="submit" name="idPaciente" value="" class="btn btn-outline-danger btn-sm" onclick="return confirm('¿Estás paciente de que quieres eliminar al paciente?')">
